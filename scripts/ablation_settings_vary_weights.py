...
fixed_args = {
    "--results_dir": ["results_ablation_vary_weights"],
    # Model:
    "--feature_dim": [64],
...
ablation_settings = []
for i in [0.1, 0.5, 2.0, 10.0]:
    ablation_settings.append(
        {"--linearity_loss_coeff": 1.0, "--real_CE_loss_coeff": i, "--fake_CE_loss_coeff": i, "--data_noise_SNR": 20}
    )
